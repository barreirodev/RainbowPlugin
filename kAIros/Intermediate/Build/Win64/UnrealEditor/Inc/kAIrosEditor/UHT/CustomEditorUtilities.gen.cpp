...
#include "kAIrosEditor/Public/CustomEditorUtilities.h"
...
// Cross Module References
	...
	KAIROSEDITOR_API UClass* Z_Construct_UClass_UCustomEditorUtilities();
	KAIROSEDITOR_API UClass* Z_Construct_UClass_UCustomEditorUtilities_NoRegister();
	...
	KAIROSEDITOR_API UScriptStruct* Z_Construct_UScriptStruct_FScreenShotParams();
...
class UScriptStruct* FScreenShotParams::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ScreenShotParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FScreenShotParams, (UObject*)Z_Construct_UPackage__Script_kAIrosEditor(), TEXT("ScreenShotParams"));
	}
	return Z_Registration_Info_UScriptStruct_ScreenShotParams.OuterSingleton;
}
template<> KAIROSEDITOR_API UScriptStruct* StaticStruct<FScreenShotParams>()
{
	...
	struct Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics
	{
		struct _Script_kAIrosEditor_eventOnProcessFinished_Parms
		{
			bool Result;
		};
	...
	void Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::NewProp_Result_SetBit(void* Obj)
	{
		((_Script_kAIrosEditor_eventOnProcessFinished_Parms*)Obj)->Result = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(_Script_kAIrosEditor_eventOnProcessFinished_Parms), &Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::NewProp_Result_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::NewProp_Result,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CustomEditorUtilities.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_kAIrosEditor, nullptr, "OnProcessFinished__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::_Script_kAIrosEditor_eventOnProcessFinished_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::_Script_kAIrosEditor_eventOnProcessFinished_Parms) < MAX_uint16);
	UFunction* Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature_Statics::FuncParams);
		}
...
void FOnProcessFinished_DelegateWrapper(const FMulticastScriptDelegate& OnProcessFinished, bool Result)
{
	...
	_Script_kAIrosEditor_eventOnProcessFinished_Parms Parms;
	Parms.Result=Result ? true : false;
	OnProcessFinished.ProcessMulticastDelegate<UObject>(&Parms);
}
	struct Z_Construct_UDelegateFunction_kAIrosEditor_OnOutputTextChanged__DelegateSignature_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_kAIrosEditor_OnOutputTextChanged__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CustomEditorUtilities.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_kAIrosEditor_OnOutputTextChanged__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_kAIrosEditor, nullptr, "OnOutputTextChanged__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_kAIrosEditor_OnOutputTextChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_kAIrosEditor_OnOutputTextChanged__DelegateSignature_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UDelegateFunction_kAIrosEditor_OnOutputTextChanged__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_kAIrosEditor_OnOutputTextChanged__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FOnOutputTextChanged_DelegateWrapper(const FMulticastScriptDelegate& OnOutputTextChanged)
{
	...
	struct Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics
	{
		struct _Script_kAIrosEditor_eventOnProgressBarUpdated_Parms
		{
			float Value;
		};
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_kAIrosEditor_eventOnProgressBarUpdated_Parms, Value), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::NewProp_Value,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CustomEditorUtilities.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_kAIrosEditor, nullptr, "OnProgressBarUpdated__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::_Script_kAIrosEditor_eventOnProgressBarUpdated_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::_Script_kAIrosEditor_eventOnProgressBarUpdated_Parms) < MAX_uint16);
	UFunction* Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FOnProgressBarUpdated_DelegateWrapper(const FMulticastScriptDelegate& OnProgressBarUpdated, float Value)
{
	...
	_Script_kAIrosEditor_eventOnProgressBarUpdated_Parms Parms;
	Parms.Value=Value;
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCustomEditorUtilities_Statics::NewProp_ProcessFinished = { "ProcessFinished", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCustomEditorUtilities, ProcessFinished), Z_Construct_UDelegateFunction_kAIrosEditor_OnProcessFinished__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomEditorUtilities_Statics::NewProp_ProcessFinished_MetaData), Z_Construct_UClass_UCustomEditorUtilities_Statics::NewProp_ProcessFinished_MetaData) }; // 3086699071
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCustomEditorUtilities_Statics::NewProp_OutputTextChanged = { "OutputTextChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCustomEditorUtilities, OutputTextChanged), Z_Construct_UDelegateFunction_kAIrosEditor_OnOutputTextChanged__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomEditorUtilities_Statics::NewProp_OutputTextChanged_MetaData), Z_Construct_UClass_UCustomEditorUtilities_Statics::NewProp_OutputTextChanged_MetaData) }; // 1231543273
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCustomEditorUtilities_Statics::NewProp_ProgressBarUpdated = { "ProgressBarUpdated", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCustomEditorUtilities, ProgressBarUpdated), Z_Construct_UDelegateFunction_kAIrosEditor_OnProgressBarUpdated__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomEditorUtilities_Statics::NewProp_ProgressBarUpdated_MetaData), Z_Construct_UClass_UCustomEditorUtilities_Statics::NewProp_ProgressBarUpdated_MetaData) }; // 3115822019
#if WITH_METADATA
	...
	template<> KAIROSEDITOR_API UClass* StaticClass<UCustomEditorUtilities>()
	{
		return UCustomEditorUtilities::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UCustomEditorUtilities);
	UCustomEditorUtilities::~UCustomEditorUtilities() {}
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_kAIros_Source_kAIrosEditor_Public_CustomEditorUtilities_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_kAIros_Source_kAIrosEditor_Public_CustomEditorUtilities_h_Statics::ScriptStructInfo[] = {
		{ FScreenShotParams::StaticStruct, Z_Construct_UScriptStruct_FScreenShotParams_Statics::NewStructOps, TEXT("ScreenShotParams"), &Z_Registration_Info_UScriptStruct_ScreenShotParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScreenShotParams), 1823573182U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_kAIros_Source_kAIrosEditor_Public_CustomEditorUtilities_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCustomEditorUtilities, UCustomEditorUtilities::StaticClass, TEXT("UCustomEditorUtilities"), &Z_Registration_Info_UClass_UCustomEditorUtilities, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCustomEditorUtilities), 4250349387U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_kAIros_Source_kAIrosEditor_Public_CustomEditorUtilities_h_4224042365(TEXT("/Script/kAIrosEditor"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_kAIros_Source_kAIrosEditor_Public_CustomEditorUtilities_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_kAIros_Source_kAIrosEditor_Public_CustomEditorUtilities_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_kAIros_Source_kAIrosEditor_Public_CustomEditorUtilities_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_kAIros_Source_kAIrosEditor_Public_CustomEditorUtilities_h_Statics::ScriptStructInfo),
		nullptr, 0);
